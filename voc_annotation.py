...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_path", default="../YOLOv3/data/dataset/")
    parser.add_argument("--train_annotation", default="../YOLOv3/data/dataset/dog_train.txt")
    parser.add_argument("--test_annotation",  default="../YOLOv3/data/dataset/dog_test.txt")
...
#    num3 = convert_voc_annotation(os.path.join(flags.data_path, 'test/VOCdevkit/VOC2007'),  'test', flags.test_annotation, False)
    num1 = convert_voc_annotation(os.path.join(flags.data_path, ''), 'train_file', flags.train_annotation, False)
    num3 = convert_voc_annotation(os.path.join(flags.data_path, ''),  'test_file', flags.test_annotation, False)
